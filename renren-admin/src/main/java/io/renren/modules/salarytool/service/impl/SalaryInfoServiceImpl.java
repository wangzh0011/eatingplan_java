...
public class SalaryInfoServiceImpl extends ServiceImpl<SalaryInfoDao, SalaryInfo> implements SalaryInfoService {
	...
	public List<SalaryInfo> queryByCondition(SalaryInfo salaryInfo) {
		...
		String ages = "";
		if(ageInterval != null && !"".equals(ageInterval)) {
			ages = TranslationUtil.ageIntervalTranslation(ageInterval);
		}
	...
	@Override
	public String queryAvg(SalaryInfo salaryInfo) {
		return baseMapper.queryAvg(salaryInfo);
	}
